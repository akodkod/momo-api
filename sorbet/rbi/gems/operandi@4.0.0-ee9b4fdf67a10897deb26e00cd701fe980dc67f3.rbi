...
class Operandi::Base
  ...
  #
  # pkg:gem/operandi#lib/operandi/base.rb:71
  ...
  # @return [void]
  #
  # pkg:gem/operandi#lib/operandi/base.rb:162
  sig { void }
  def call; end
  ...
  # @return [Boolean] true
  #
  # pkg:gem/operandi#lib/operandi/base.rb:120
  sig { void }
  def done!; end
  ...
  #
  # pkg:gem/operandi#lib/operandi/base.rb:128
  ...
  # @return [void]
  #
  # pkg:gem/operandi#lib/operandi/base.rb:143
  ...
  # @return [void]
  #
  # pkg:gem/operandi#lib/operandi/base.rb:153
  ...
  #
  # pkg:gem/operandi#lib/operandi/base.rb:96
  sig { returns(T::Boolean) }
  def failed?; end
  ...
  # @return [Boolean] true
  #
  # pkg:gem/operandi#lib/operandi/base.rb:117
  sig { void }
  def stop!; end
  ...
  # @return [void]
  #
  # pkg:gem/operandi#lib/operandi/base.rb:134
  ...
  # @return [Boolean] true if stop! was called
  #
  # pkg:gem/operandi#lib/operandi/base.rb:125
  sig { returns(T::Boolean) }
  def stopped?; end
  ...
  #
  # pkg:gem/operandi#lib/operandi/base.rb:88
  # Instance methods
  sig { returns(T::Boolean) }
  def success?; end
  ...
  # @return [Boolean] true if no errors were added
  #
  # pkg:gem/operandi#lib/operandi/base.rb:91
  sig { returns(T::Boolean) }
  def successful?; end

  # @return [Messages] collection of warning messages
  #
  # pkg:gem/operandi#lib/operandi/base.rb:64
  sig { returns(Operandi::Messages) }
  def warnings; end
  ...
  #
  # pkg:gem/operandi#lib/operandi/base.rb:110
  sig { returns(T::Boolean) }
  def warnings?; end
  ...
  class << self
    ...
    #
    # pkg:gem/operandi#lib/operandi/base.rb:179
    ...
    #
    # pkg:gem/operandi#lib/operandi/base.rb:185
    ...
    #
    # pkg:gem/operandi#lib/operandi/base.rb:224
    sig do
      params(
...
class Operandi::Messages
  ...
  #
  # pkg:gem/operandi#lib/operandi/messages.rb:48
  ...
  # @return [void]
  #
  # pkg:gem/operandi#lib/operandi/messages.rb:76
  sig do
    params(
      key: Symbol,
  ...
  #
  # pkg:gem/operandi#lib/operandi/messages.rb:98
  sig { returns(T::Boolean) }
  def break?; end
  ...
  # @return [void]
  #
  # pkg:gem/operandi#lib/operandi/messages.rb:114
  ...
  #
  # pkg:gem/operandi#lib/operandi/messages.rb:57
  sig { returns(Integer) }
  def count; end
  ...
  # @return [void]
  #
  # pkg:gem/operandi#lib/operandi/messages.rb:129
  sig { params(entity: T.untyped, opts: T::Hash[Symbol, T.untyped]).void }
  ...
  #
  # pkg:gem/operandi#lib/operandi/messages.rb:40
  ...
  #
  # pkg:gem/operandi#lib/operandi/messages.rb:134
  ...
  # pkg:gem/operandi#lib/operandi/messages.rb:146
  def break!(break_execution); end

  # @raise [Operandi::Error]
  #
  # pkg:gem/operandi#lib/operandi/messages.rb:152
  def raise!(message); end

  # @raise [ActiveRecord::Rollback]
  #
  # pkg:gem/operandi#lib/operandi/messages.rb:158
  def rollback!(rollback); end

  # @return [Boolean]
  #
  # pkg:gem/operandi#lib/operandi/messages.rb:140
...
#
# pkg:gem/operandi#lib/operandi/constants.rb:96
...
# Aliases for backwards compatibility
#
# pkg:gem/operandi#lib/operandi/settings/field.rb:124
...
class Operandi::Settings::Field
  ...
  # pkg:gem/operandi#lib/operandi/settings/field.rb:110
  ...
  # @return [Boolean]
  #
  # pkg:gem/operandi#lib/operandi/settings/field.rb:67
  ...
  # pkg:gem/operandi#lib/operandi/settings/field.rb:104
  ...
  #
  # pkg:gem/operandi#lib/operandi/settings/field.rb:98
  ...
  #
  # pkg:gem/operandi#lib/operandi/settings/field.rb:88
  def validate_sorbet_type!(value); end
end

# pkg:gem/operandi#lib/operandi/settings/field.rb:125
