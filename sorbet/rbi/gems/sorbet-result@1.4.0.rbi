...
class Typed::Failure < ::Typed::Result
  ...
  # pkg:gem/sorbet-result#lib/typed/result.rb:188
  sig { params(error: Error).void }
  def initialize(error); end

  # pkg:gem/sorbet-result#lib/typed/result.rb:239
  sig { params(other: T.untyped).returns(T::Boolean) }
  def ==(other); end

  # pkg:gem/sorbet-result#lib/typed/result.rb:214
  sig do
    override
      .type_parameters(:U, :T)
      .params(
  ...
  # pkg:gem/sorbet-result#lib/typed/result.rb:171
  sig { override.returns(Error) }
  def error; end

  # pkg:gem/sorbet-result#lib/typed/result.rb:199
  sig { override.returns(T::Boolean) }
  def failure?; end

  # pkg:gem/sorbet-result#lib/typed/result.rb:223
  sig { override.params(block: T.proc.params(arg0: Error).void).returns(T.self_type) }
  def on_error(&block); end

  # @raise [NoPayloadOnFailureError]
  #
  # pkg:gem/sorbet-result#lib/typed/result.rb:204
  sig { override.returns(T.noreturn) }
  def payload; end

  # pkg:gem/sorbet-result#lib/typed/result.rb:234
  sig do
    override
  ...
  # pkg:gem/sorbet-result#lib/typed/result.rb:194
  sig { override.returns(T::Boolean) }
  def success?; end

  class << self
    # pkg:gem/sorbet-result#lib/typed/result.rb:183
    sig { returns(Typed::Failure[::NilClass]) }
    def blank; end

    # pkg:gem/sorbet-result#lib/typed/result.rb:178
    sig { type_parameters(:T).params(error: T.type_parameter(:T)).returns(Typed::Failure[T.type_parameter(:T)]) }
    def new(error); end
  end
end
...
#
# pkg:gem/sorbet-result#lib/typed/no_error_on_success_error.rb:6
class Typed::NoErrorOnSuccessError < ::StandardError
  # pkg:gem/sorbet-result#lib/typed/no_error_on_success_error.rb:10
  sig { void }
  def initialize; end
end
...
# Error when user attempts to access payload from a Failure Result.
#
# pkg:gem/sorbet-result#lib/typed/no_payload_on_failure_error.rb:6
class Typed::NoPayloadOnFailureError < ::StandardError
  # pkg:gem/sorbet-result#lib/typed/no_payload_on_failure_error.rb:10
...
#
# pkg:gem/sorbet-result#lib/typed/result.rb:11
class Typed::Result
  extend T::Generic
  ...
  # @abstract
  #
  # pkg:gem/sorbet-result#lib/typed/result.rb:44
  sig do
    abstract
      .type_parameters(:U, :T)
      .params(
  ...
  # @abstract
  #
  # pkg:gem/sorbet-result#lib/typed/result.rb:35
  sig { abstract.returns(Error) }
  def error; end

  # @abstract
  #
  # pkg:gem/sorbet-result#lib/typed/result.rb:27
  sig { abstract.returns(T::Boolean) }
  def failure?; end

  # @abstract
  #
  # pkg:gem/sorbet-result#lib/typed/result.rb:52
  sig { abstract.params(block: T.proc.params(arg0: Error).void).returns(T.self_type) }
  def on_error(&block); end

  # @abstract
  #
  # pkg:gem/sorbet-result#lib/typed/result.rb:31
  sig { abstract.returns(Payload) }
  def payload; end

  # @abstract
  #
  # pkg:gem/sorbet-result#lib/typed/result.rb:61
  sig do
    abstract
      .type_parameters(:Fallback)
      .params(
  ...
  # @abstract
  #
  # pkg:gem/sorbet-result#lib/typed/result.rb:23
  sig { abstract.returns(T::Boolean) }
  def success?; end
end

# pkg:gem/sorbet-result#lib/typed/result.rb:65
class Typed::Success < ::Typed::Result
  ...
  # pkg:gem/sorbet-result#lib/typed/result.rb:90
  sig { params(payload: Payload).void }
  def initialize(payload); end

  # pkg:gem/sorbet-result#lib/typed/result.rb:140
  sig { params(other: T.untyped).returns(T::Boolean) }
  def ==(other); end

  # pkg:gem/sorbet-result#lib/typed/result.rb:116
  sig do
    override
      .type_parameters(:U, :T)
      .params(
  ...
  #
  # pkg:gem/sorbet-result#lib/typed/result.rb:106
  sig { override.returns(T.noreturn) }
  def error; end

  # pkg:gem/sorbet-result#lib/typed/result.rb:101
  sig { override.returns(T::Boolean) }
  def failure?; end

  # pkg:gem/sorbet-result#lib/typed/result.rb:125
  sig { override.params(_block: T.proc.params(arg0: Error).void).returns(T.self_type) }
  def on_error(&_block); end

  # pkg:gem/sorbet-result#lib/typed/result.rb:73
  sig { override.returns(Payload) }
  def payload; end

  # pkg:gem/sorbet-result#lib/typed/result.rb:135
  sig do
    override
      .type_parameters(:Fallback)
      .params(
  ...
  # pkg:gem/sorbet-result#lib/typed/result.rb:96
  sig { override.returns(T::Boolean) }
  def success?; end

  class << self
    # pkg:gem/sorbet-result#lib/typed/result.rb:85
    sig { returns(Typed::Success[::NilClass]) }
    def blank; end

    # pkg:gem/sorbet-result#lib/typed/result.rb:80
    sig { type_parameters(:T).params(payload: T.type_parameter(:T)).returns(Typed::Success[T.type_parameter(:T)]) }
    def new(payload); end
  end
end
